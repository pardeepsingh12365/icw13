...
exports.run = async (bot, message, args, command, db) => {
  ...
  var slink;
  if (guildQueue.nowPlaying.url.startsWith(`https://www.youtube.com`)) {
    slink = guildQueue.nowPlaying.url
  } else {
...
${"🎧"} [${guildQueue.nowPlaying.name}](${slink})
length ${ProgressBar.prettier}`)
      .setThumbnail(`${guildQueue.nowPlaying.thumbnail}`)
      .setFooter(`Added by ${guildQueue.nowPlaying.user}`, guildQueue.nowPlaying.usravatar)
